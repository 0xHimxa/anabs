...
<div className=" mb-4 pt-3 pb-2  border-1 border-gray-400"><input type="text" placeholder="Enter Email" className="w-[100%] h-7 border-none rounded pr-2 pl-2 text-lg input-f"/></div>
<div className=" pt-3 pb-2  border-1 border-gray-400"><input type="text" placeholder="Password" className="w-[100%] h-7 border-none rounded pr-2 pl-2 text-lg input-f"/></div>
...
pt-3 rounded border-1 border-solid">
